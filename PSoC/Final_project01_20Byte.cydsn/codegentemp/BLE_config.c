...
cy_stc_ble_gapp_disc_param_t cy_ble_discoveryParam[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        ...
        {0xFFu, 0xBBu, 0xAAu, 0x50u, 0xA0u, 0x00u}, /* uint8_t* direct_addr */ 
...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x02u, 0x01u, 0x06u, 0x09u, 0x09u, 0x47u, 0x41u,
        0x54u, 0x54u, 0x5Fu, 0x4Fu, 0x75u, 0x74u, 0x03u,
...
cy_stc_ble_gapp_scan_rsp_data_t cy_ble_scanRspData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x09u, 0x09u, 0x47u, 0x41u, 0x54u, 0x54u, 0x5Fu,
        0x4Fu, 0x75u, 0x74u, 0x00u, 0x00u, 0x00u, 0x00u,
        0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
        0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
...
static uint8_t cy_ble_attValues[0x0218u] = {
    /* Device Name */
    (uint8_t)'G', (uint8_t)'A', (uint8_t)'T', (uint8_t)'T', (uint8_t)'_', (uint8_t)'O', (uint8_t)'u', (uint8_t)'t', 
...
0x00u, 0x00u, 
    ...
    /* Custom Descriptor */
    0x00u, 0x5Du, 0xF8u, 0x82u, 0x4Fu, 0x30u, 0x3Bu, 0xACu, 0xBFu, 0x14u, 0x44u, 0xBEu, 0x5Bu, 0x01u, 0xAEu, 0x8Eu, 0xBFu, 
...
static const uint8_t cy_ble_attUuid128[][16u] = {
    /* BLE Throughput */
    { 0x8Fu, 0x85u, 0xFBu, 0x3Du, 0x0Eu, 0x5Cu, 0x5Cu, 0xB2u, 0xDFu, 0x43u, 0xD1u, 0x48u, 0x86u, 0x8Eu, 0x24u, 0x89u },
    /* Custom Characteristic */
    { 0x1Eu, 0xF2u, 0x36u, 0xA3u, 0x91u, 0x82u, 0x72u, 0xBEu, 0xD4u, 0x4Du, 0xD5u, 0x54u, 0xD4u, 0x56u, 0x1Eu, 0xF8u },
};
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x10u] = {
    ...
    { 0x0000u, (void *)&cy_ble_attValues[24] }, /* Manufacturer Name String */
    { 0x0000u, (void *)&cy_ble_attValues[24] }, /* Model Number String */
    { 0x0000u, (void *)&cy_ble_attValues[24] }, /* Hardware Revision String */
    { 0x0000u, (void *)&cy_ble_attValues[24] }, /* Firmware Revision String */
    { 0x0010u, (void *)&cy_ble_attUuid128[0] }, /* BLE Throughput UUID */
    { 0x0010u, (void *)&cy_ble_attUuid128[1] }, /* Custom Characteristic UUID */
    { 0x01EFu, (void *)&cy_ble_attValues[24] }, /* Custom Characteristic */
    { 0x0001u, (void *)&cy_ble_attValues[519] }, /* Custom Descriptor */
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x1Du] = {
    ...
    { 0x0010u, 0x2800u /* Primary service                     */, 0x00000001u /*       */, 0x0018u, {{0x180Au, NULL}}                           },
    { 0x0011u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x0012u, {{0x2A29u, NULL}}                           },
    { 0x0012u, 0x2A29u /* Manufacturer Name String            */, 0x01020001u /* rd    */, 0x0012u, {{0x0000u, (void *)&cy_ble_attValuesLen[7]}} },
    { 0x0013u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x0014u, {{0x2A24u, NULL}}                           },
    { 0x0014u, 0x2A24u /* Model Number String                 */, 0x01020001u /* rd    */, 0x0014u, {{0x0000u, (void *)&cy_ble_attValuesLen[8]}} },
    { 0x0015u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x0016u, {{0x2A27u, NULL}}                           },
    { 0x0016u, 0x2A27u /* Hardware Revision String            */, 0x01020001u /* rd    */, 0x0016u, {{0x0000u, (void *)&cy_ble_attValuesLen[9]}} },
    { 0x0017u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x0018u, {{0x2A26u, NULL}}                           },
    { 0x0018u, 0x2A26u /* Firmware Revision String            */, 0x01020001u /* rd    */, 0x0018u, {{0x0000u, (void *)&cy_ble_attValuesLen[10]}} },
    { 0x0019u, 0x2800u /* Primary service                     */, 0x08000001u /*       */, 0x001Du, {{0x0010u, (void *)&cy_ble_attValuesLen[11]}} },
    { 0x001Au, 0x2803u /* Characteristic                      */, 0x00100001u /* ntf   */, 0x001Du, {{0x0010u, (void *)&cy_ble_attValuesLen[12]}} },
    { 0x001Bu, 0x56D4u /* Custom Characteristic               */, 0x09100000u /* ntf   */, 0x001Du, {{0x01EFu, (void *)&cy_ble_attValuesLen[13]}} },
    { 0x001Cu, 0xAE01u /* Custom Descriptor                   */, 0x09000001u /*       */, 0x001Cu, {{0x0001u, (void *)&cy_ble_attValuesLen[14]}} },
    { 0x001Du, 0x2902u /* Client Characteristic Configuration */, 0x030A0001u /* rd,wr */, 0x001Du, {{0x0002u, (void *)&cy_ble_attValuesLen[15]}} },
};
...
cy_stc_ble_gap_bd_addr_t cy_ble_deviceAddress = {{0xFFu, 0xBBu, 0xAAu, 0x50u, 0xA0u, 0x00u}, 0x00u };
