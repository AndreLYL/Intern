...
/* ARM CM4 */
    ...
    /* WS_SPI_SCB_IRQ */
    const cy_stc_sysint_t WS_SPI_SCB_IRQ_cfg = {
        .intrSrc = (IRQn_Type)WS_SPI_SCB_IRQ__INTC_NUMBER,
        .intrPriority = WS_SPI_SCB_IRQ__INTC_CORTEXM4_PRIORITY
    };

    /* WS_DMA_INT */
    const cy_stc_sysint_t WS_DMA_INT_cfg = {
        .intrSrc = (IRQn_Type)WS_DMA_INT__INTC_NUMBER,
