...
#define CY_BLE_CONFIG_GATT_DB_MAX_VALUE_LEN         (0x01EFu)
 ...
 */
#define CY_BLE_BLE_THROUGHPUT_SERVICE_INDEX   (0x00u) /* Index of BLE Throughput service in the cy_ble_customs array */
#define CY_BLE_BLE_THROUGHPUT_CUSTOM_CHARACTERISTIC_CHAR_INDEX   (0x00u) /* Index of Custom Characteristic characteristic */
#define CY_BLE_BLE_THROUGHPUT_CUSTOM_CHARACTERISTIC_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CY_BLE_BLE_THROUGHPUT_CUSTOM_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */


#define CY_BLE_BLE_THROUGHPUT_SERVICE_HANDLE   (0x0019u) /* Handle of BLE Throughput service */
#define CY_BLE_BLE_THROUGHPUT_CUSTOM_CHARACTERISTIC_DECL_HANDLE   (0x001Au) /* Handle of Custom Characteristic characteristic declaration */
#define CY_BLE_BLE_THROUGHPUT_CUSTOM_CHARACTERISTIC_CHAR_HANDLE   (0x001Bu) /* Handle of Custom Characteristic characteristic */
#define CY_BLE_BLE_THROUGHPUT_CUSTOM_CHARACTERISTIC_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x001Cu) /* Handle of Custom Descriptor descriptor */
#define CY_BLE_BLE_THROUGHPUT_CUSTOM_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x001Du) /* Handle of Client Characteristic Configuration descriptor */
